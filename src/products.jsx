...
const produtos = [
  // FRUTAS
  { nome: 'Abacate', unidades: ['un', 'kg'], categoria: 'frutas' },
  { nome: 'Abacaxi', unidades: ['un'], categoria: 'frutas' },
  { nome: 'Ameixa', unidades: ['un', 'kg'], categoria: 'frutas' },
  { nome: 'Banana Caturra', unidades: ['un', 'kg'], categoria: 'frutas' },
  { nome: 'Banana Prata', unidades: ['un', 'kg'], categoria: 'frutas' },
  { nome: 'Banana Terra', unidades: ['un', 'kg'], categoria: 'frutas' },
  { nome: 'Côco Seco', unidades: ['un', 'kg'], categoria: 'frutas' },
  { nome: 'Côco Verde', unidades: ['un'], categoria: 'frutas' },
  { nome: 'Figo', unidades: ['bdj'], categoria: 'frutas' },
  { nome: 'Goiaba', unidades: ['un', 'kg'], categoria: 'frutas' },
  { nome: 'Kiwi', unidades: ['un', 'kg'], categoria: 'frutas' },
  ...
  { nome: 'Uva Rubi', unidades: ['bdj', 'kg'], categoria: 'frutas' },
  { nome: 'Uva Verde', unidades: ['bdj', 'kg'], categoria: 'frutas' },
  ...
  { nome: 'Batata Asterix', unidades: ['un', 'kg'], categoria: 'legumes' },
  ...
  // OUTROS
  { nome: 'Alho com casca', unidades: ['un', 'pente'], categoria: 'outros' },
  ...
  { nome: 'Alface Crespa', unidades: ['un'], categoria: 'verduras' },
